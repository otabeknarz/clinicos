...
function useStoryMotion(rootRef: RefObject<HTMLElement | null>) {
  useEffect(() => {
     ...
     */
    function enter(element: Element | null | undefined, delay = 0, distance = 22) {
      play(
        element,
        [
      ...
      element
        ...
        .forEach((icon, index) =>
          play(
            ...
            { duration: 520, delay: delay + 120 + index * 60, easing: spring },
          ),
        )
      ...
      element
        ...
        .forEach((value, index) =>
          play(
            ...
            { duration: 500, delay: delay + 160 + index * 70, easing: spring },
          ),
        )
    }
    ...
    if (hero) {
      Array.from(hero.children)
        ...
        .forEach((element, index) => enter(element, index * 70, 16))
    }
    ...
    root
      ...
      .forEach((element, index) => {
        if (element.matches('.v3-card,.v3-extra')) {
          ...
          element.dataset.motionDelay = String((index % 2) * 70)
        }
